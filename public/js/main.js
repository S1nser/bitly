...
(function () {
  ...
  // Класс .reveal вешаем только отсюда, из JS: если скрипт не выполнился
  // или IntersectionObserver не поддерживается — элементы с [data-reveal]
  // остаются как обычно видимыми (opacity не задан в разметке), без риска
