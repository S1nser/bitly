...
module.exports = function createAdminRouter(getBot) {
  ...
  router.post('/api/applications/:id/offers', async (req, res) => {
    const {
      ...
      productName, productLink, conversionRate, adminFee, potentialEarnings, managerUsername, isBest
    } = req.body || {};
    ...
    try {
      ...
      const offer = await db.createOffer(req.params.id, {
        ...
        conversionRate: conversionRate ? String(conversionRate).trim().slice(0, 60) : null,
